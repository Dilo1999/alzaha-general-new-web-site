    ...
    <section class="py-[120px] bg-[#f7f4eb]">
        <x-container>
            <div class="text-center max-w-[720px] mx-auto animate-on-scroll" data-animate="fadeInUp">
                <h1 class="text-3xl sm:text-5xl mb-6 text-[#6d5a2c]">Insights & Resources</h1>
                <p class="text-xl leading-relaxed opacity-80 text-[#6d5a2c]">Expert insights on supply chain management, global sourcing, logistics, and procurement strategies for the MENA region.</p>
            </div>
        </x-container>
    </section>
                    ...
                    <a href="{{ route('blogs.show', $post->slug) }}" class="group block animate-on-scroll" data-animate="fadeInUp" data-delay="{{ $index * 0.1 }}">
                        <article class="bg-white rounded-[14px] overflow-hidden shadow-sm hover:shadow-2xl transition-all duration-500 ease-out border border-[#6d5a2c]/5 h-full flex flex-col">
                            ...
                            <div class="p-8 flex flex-col flex-grow">
                                <h2 class="text-xl font-bold mb-6 leading-tight transition-colors group-hover:text-[#c19b46] flex-grow text-[#6d5a2c]">{{ $post->title }}</h2>
    ...
    <section class="py-[120px] bg-[#f7f4eb]">
        <x-container>
            <div class="text-center max-w-2xl mx-auto animate-on-scroll" data-animate="fadeInUp">
                <h2 class="text-3xl sm:text-4xl mb-6 text-[#6d5a2c]">Ready to Transform Your Supply Chain?</h2>
                <p class="text-lg mb-10 leading-relaxed opacity-80 text-[#6d5a2c]">Let's discuss how Al Zaha can optimize your sourcing and logistics operations.</p>
                <a href="{{ route('contact') }}" class="inline-block px-10 py-4 text-white font-bold transition-all duration-300 ease-out hover:scale-105 rounded-full shadow-lg hover:shadow-xl bg-[#c19b46]">Contact Our Team</a>
            </div>
        </x-container>
    </section>
</div>
