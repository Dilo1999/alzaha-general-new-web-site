<section class="relative min-h-screen lg:h-[85vh] lg:min-h-[700px] flex items-center pt-[120px] lg:pt-[88px] overflow-hidden">
    ...
    <div class="relative w-full max-w-[1320px] mx-auto px-4 md:px-8 py-20 lg:py-0">
        <div class="max-w-[720px] animate-now" data-animate="slideLeft">
            <h1 class="text-white mb-6 md:mb-8 leading-tight font-bold" style="font-size: 32.4px;">
                Take control of your international sourcing from Dubai
            </h1>

            <p class="text-white/90 mb-8 md:mb-10 leading-relaxed max-w-2xl" style="font-size: 16.2px;">
            ...
            <div class="flex flex-col sm:flex-row gap-4 mb-12 md:mb-16">
                <a href="{{ route('quote') }}" class="px-10 py-4 text-white font-bold transition-all duration-300 ease-out hover:scale-105 rounded-full shadow-lg hover:shadow-xl text-center bg-[#c19b46]" style="font-size: 14.4px;">
                    Request a Quote
                </a>
                <a href="#how-it-works" class="px-10 py-4 text-white font-bold border-2 transition-all duration-300 ease-out hover:scale-105 rounded-full backdrop-blur-sm bg-white/5 hover:bg-white/10 text-center" style="border-color:#c19b46; font-size: 14.4px;">
                    How it Works
                </a>
            </div>
            ...
            <div class="flex flex-col sm:flex-row gap-6 md:gap-10">
                <div class="flex items-center gap-3 group">
                    ...
                    <span class="text-white/80" style="font-size: 12.6px;">Verified Suppliers</span>
                </div>
                <div class="flex items-center gap-3 group">
                    <div class="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center transition-colors group-hover:bg-white/20">
                        {{-- Shield --}}
                    ...
                    <span class="text-white/80" style="font-size: 12.6px;">Consolidated Shipments</span>
                </div>
                <div class="flex items-center gap-3 group">
                    <div class="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center transition-colors group-hover:bg-white/20">
                        {{-- Trending Up --}}
                    ...
                    <span class="text-white/80" style="font-size: 12.6px;">Coordinated Delivery</span>
                </div>
            </div>
        </div>
    </div>
