<div class="bg-white p-6 md:p-10 rounded-2xl shadow-2xl border border-[#6d5a2c]/5">
    <h3 class="font-bold mb-8 text-[#6d5a2c]" style="font-size: 18px;">Send us a Message</h3>
    ...
    <form action="{{ route('contact.store') }}" method="POST" class="space-y-6">
        ...
        <div class="space-y-2">
            <label for="contact-name" class="font-semibold opacity-60 ml-1 text-[#6d5a2c]" style="font-size: 12.6px;">Name</label>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div class="space-y-2">
                <label for="contact-email" class="font-semibold opacity-60 ml-1 text-[#6d5a2c]" style="font-size: 12.6px;">Email</label>
            ...
            <div class="space-y-2">
                <label for="contact-subject" class="font-semibold opacity-60 ml-1 text-[#6d5a2c]" style="font-size: 12.6px;">Subject</label>
        ...
        <div class="space-y-2">
            <label for="contact-message" class="font-semibold opacity-60 ml-1 text-[#6d5a2c]" style="font-size: 12.6px;">Message</label>
        ...
        <button type="submit" class="w-full py-4 text-white font-bold rounded-xl flex items-center justify-center gap-2 transition-all duration-300 hover:scale-[1.01] shadow-lg bg-[#c19b46]" style="font-size: 14.4px;">
            Send Message
